        ...
        for ( int i=0 ; i<input.size() ; i++ ) {
            ...
            if ( target_indices[input[i]-'a'] != -1 ) {
                ...
                if ( last_known [ input[i]-'a' ] != -1 ) {
                    ...
                    for ( int j = target_indices[input[i]-'a']+1 ; j<target.size() ; j++ )
                ...
                // DEBUG 
                // cout << "element : " << input[i] << " , insertion index : " << insertion_index << endl;
                // cout << "last known : " << last_known[input[i]-'a'] << endl;
                // cout << "answer : " ;
                // print ( answer );
                // cout << endl;
                // DEBUG
