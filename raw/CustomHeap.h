...
class CustomHeap {
 private:
  ...
  priority_queue<container,
                 vector<container>,
                 function<bool(container, container)> >
      data;
...
template <typename container>
CustomHeap<container>::CustomHeap(
    function<bool(container, container)> comparator_input) {
  priority_queue<container, vector<container>,
                 function<bool(container, container)> >
      temp_decl(comparator_input);
  data = temp_decl;
}
